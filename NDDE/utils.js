...
export const disasterImpactData = {
  ...
  injured: (data) => ({
    ...
    "Mass movements (dry)":
      +data["Number of people injured from mass movements"],
    ...
    "Extreme temperatures":
      +data["Number of people injured from extreme temperatures"],
  }),
  affected: (data) => ({
    ...
    "Mass movements (dry)":
      +data["Number of total people affected by mass movements"],
    ...
    "Extreme temperatures":
      +data["Number of total people affected by extreme temperatures"],
  }),
  homeless: (data) => ({
    ...
    "Mass movements (dry)":
      +data["Number of people left homeless from mass movements"],
    ...
    "Extreme temperatures":
      +data["Number of people left homeless from extreme temperatures"],
  }),
  "economic damages": (data) => ({
    "All disasters":
      +data["Total economic damages from disasters as a share of GDP"],
    Droughts: +data["Total economic damages from drought as a share of GDP"],
    Earthquakes:
      +data["Total economic damages from earthquakes as a share of GDP"],
    Volcanoes:
      +data["Total economic damages from volcanic activity as a share of GDP"],
    Floods: +data["Total economic damages from floods as a share of GDP"],
    "Mass movements (dry)":
      +data["Total economic damages from mass movements as a share of GDP"],
    Storms: +data["Total economic damages from storms as a share of GDP"],
    Landslides:
      +data["Total economic damages from landslides as a share of GDP"],
...
export const colorScales = {
  // all disasters
  "Number of deaths from disasters": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 1000000])
    .range([
      "#9EB7BE",
      "#FCD49E",
      "#FDBC84",
  ...
  "Number of people injured from disasters": d3
    .scaleThreshold()
  ...
  "Number of total people affected by disasters": d3
    .scaleThreshold()
    .domain([1, 1000, 10000, 100000, 1000000, 10000000, 100000000])
    .range([
      "#9EB7BE",
      "#FEE0D2",
      "#FCBBA1",
  ...
  "Number of people left homeless from disasters": d3
    .scaleThreshold()
  ...
  "Total economic damages from disasters as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
      "#FDD0A2",
      "#FCAD6B",
  ...
  // droughts
  "Number of deaths from drought": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 1000000])
    .range(["#9EB7BE", "#FCD49E", "#FDBB84", "#FC8D59", "#E34933", "#B30100"]),
  "Number of people injured from drought": d3
    .scaleThreshold()
    .domain([1, 10, 50, 100])
    .range(["#9EB7BE", "#D7B5D8", "#DF65B0", "#DD1C77", "#980043"]),
  "Number of total people affected by drought": d3
    .scaleThreshold()
    .domain([1, 1000, 10000, 100000, 1000000, 10000000, 100000000])
    .range([
      "#9EB7BE",
  ...
  "Number of people left homeless from drought": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000])
    .range(["#9EB7BE", "#CCECE6", "#9AD8C8", "#66C2A4", "#2BA25E", "#016C2C"]),
  "Total economic damages from drought as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // earthquakes
  "Number of deaths from earthquakes": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000])
    .range(["#9EB7BE", "#FCCC8A", "#FC8D59", "#E34933", "#B30100"]),
  "Number of people injured from earthquakes": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 100000])
    .range(["#9EB7BE", "#D4B9DA", "#C994C7", "#DF65B0", "#DD1C77", "#980043"]),
  "Number of total people affected by earthquakes": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 100000, 1000000, 10000000])
    .range([
      "#9EB7BE",
      "#ECE1F0",
      "#D0D1E6",
  ...
  "Number of people left homeless from earthquakes": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 100000, 1000000, 10000000])
    .range([
      "#9EB7BE",
  ...
  "Total economic damages from earthquakes as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // volcanoes
  "Number of deaths from volcanic activity": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000])
    .range(["#9EB7BE", "#FCD49E", "#FDBC84", "#FB8D59", "#E34A33", "#B30200"]),
  "Number of people injured from volcanic activity": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000])
    .range(["#9EB7BE", "#D7B5D9", "#DF64B0", "#DD1C77", "#990043"]),
  "Number of total people affected by volcanic activity": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 100000, 1000000])
    .range([
      "#9EB7BE",
  ...
  "Number of people left homeless from volcanic activity": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 100000])
    .range(["#9EB7BE", "#CBECE6", "#9BD7C9", "#66C3A5", "#2DA25F", "#006D2D"]),
  "Total economic damages from volcanic activity as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // floods
  "Number of deaths from floods": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 1000000])
    .range(["#9EB7BE", "#FCD49E", "#FDBC84", "#FB8D59", "#E34A33", "#B30200"]),
  "Number of people injured from floods": d3
    .scaleThreshold()
  ...
  "Number of total people affected by floods": d3
    .scaleThreshold()
    .domain([1, 1000, 10000, 100000, 1000000, 10000000, 100000000])
    .range([
      "#9EB7BE",
  ...
  "Number of people left homeless from floods": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 100000, 1000000, 10000000])
    .range([
      "#9EB7BE",
  ...
  "Total economic damages from floods as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // mass movements
  "Number of deaths from mass movements": d3
    .scaleThreshold()
    .domain([1, 10, 50, 100, 500, 1000, 10000])
    .range([
      "#9EB7BE",
      "#FDE9C9",
      "#FCD49E",
  ...
  "Number of people injured from mass movements": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000])
    .range(["#9EB7BE", "#D7B5D9", "#DF64B0", "#DD1C77", "#990043"]),
  "Number of total people affected by mass movements": d3
    .scaleThreshold()
    .domain([1, 10, 100, 500, 1000])
    .range(["#9EB7BE", "#FCBCA1", "#FC9173", "#FB6A49", "#DE2E26", "#A50F16"]),
  "Number of people left homeless from mass movements": d3
    .scaleThreshold()
    .domain([1, 10, 100, 500, 1000])
    .range(["#9EB7BE", "#CBECE6", "#9BD7C9", "#66C3A5", "#2DA25F", "#006D2D"]),
  "Total economic damages from mass movements as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // storms
  "Number of deaths from storms": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000])
    .range([
      "#9EB7BE",
  ...
  "Number of people injured from storms": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000])
    .range([
      "#9EB7BE",
  ...
  "Number of total people affected by storms": d3
    .scaleThreshold()
  ...
  "Number of people left homeless from storms": d3
    .scaleThreshold()
    .domain([1, 100, 1000, 10000, 100000, 1000000, 10000000])
    .range([
      "#9EB7BE",
  ...
  "Total economic damages from storms as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // landslides
  "Number of deaths from landslides": d3
    .scaleThreshold()
  ...
  "Number of people injured from landslides": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000])
    .range(["#9EB7BE", "#D7B5D9", "#DF64B0", "#DD1C77", "#990043"]),
  "Number of total people affected by landslides": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000, 1000000])
    .range([
      "#9EB7BE",
  ...
  "Number of people left homeless from landslides": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000, 1000000])
    .range([
      "#9EB7BE",
  ...
  "Total economic damages from landslides as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // wildfires
  "Number of deaths from wildfires": d3
    .scaleThreshold()
    .domain([1, 10, 50, 100, 500])
    .range(["#9EB7BE", "#FCD49E", "#FDBC84", "#FB8D59", "#E34A33", "#B30200"]),
  "Number of people injured from wildfires": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000])
    .range(["#9EB7BE", "#D7B5D9", "#DF64B0", "#DD1C77", "#990043"]),
  "Number of total people affected by wildfires": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000, 1000000])
    .range([
      "#9EB7BE",
  ...
  "Number of people left homeless from wildfires": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000])
    .range(["#9EB7BE", "#CCECE6", "#9AD8C8", "#66C2A4", "#2BA25E", "#016C2C"]),
  "Total economic damages from wildfires as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
  ...
  // extreme temperatures
  "Number of deaths from extreme temperatures": d3
    .scaleThreshold()
    .domain([1, 10, 50, 100, 500, 1000, 10000])
    .range([
      "#9EB7BE",
  ...
  "Number of people injured from extreme temperatures": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000])
    .range([
      "#9EB7BE",
  ...
  "Number of total people affected by extreme temperatures": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000, 1000000, 10000000])
    .range([
      "#9EB7BE",
      "#FEE0D2",
      "#FCBBA1",
  ...
  "Number of people left homeless from extreme temperatures": d3
    .scaleThreshold()
    .domain([1, 10, 100, 1000, 10000, 100000])
    .range([
      "#9EB7BE",
  ...
  "Total economic damages from extreme temperatures as a share of GDP": d3
    .scaleThreshold()
    .domain([0.01, 0.05, 0.1, 0.5, 1, 10])
    .range([
      "#FEEDDE",
